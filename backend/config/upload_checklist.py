"""31-item document upload checklist for BaxterLabs engagements.
...
UPLOAD_CHECKLIST: List[dict] = [
    ...
    {"key": "trial_balance", "category": "financial", "name": "Trial Balance", "notes": "Summary of all accounts with ending balances. One-click export in any accounting system.", "priority": "required"},
    ...
    {"key": "ap_aging", "category": "financial", "name": "Accounts Payable Aging", "notes": "Current AP aging report by vendor.", "priority": "required"},
