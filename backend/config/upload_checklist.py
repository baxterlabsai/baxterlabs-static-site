"""30-item document upload checklist for BaxterLabs engagements.

Matches the official BaxterLabs Data Request Checklist (12_Data_Request_Checklist.docx).
"""
...
UPLOAD_CHECKLIST: List[dict] = [
    ...
    {"key": "trial_balance", "category": "financial", "name": "Trial Balance", "notes": "Most recent year-end + current YTD.", "priority": "required"},
    ...
    {"key": "ap_aging", "category": "vendor", "name": "Accounts Payable Aging", "notes": "Current AP aging report \u2014 0\u201330, 31\u201360, 61\u201390, 90+ buckets.", "priority": "required"},
...
TOTAL_REQUIRED: int = len(REQUIRED_ITEMS)  # 11
