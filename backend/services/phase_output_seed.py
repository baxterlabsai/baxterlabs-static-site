...
PHASE_OUTPUTS_SEED: List[dict] = [
    ...
    {"phase": 1, "output_number": 2, "name": "Preliminary Findings Memo", "file_type": "md", "destination_folder": "03_Working_Papers", "is_review_gate": True, "is_client_deliverable": False, "wave": None},
    ...
    {"phase": 4, "output_number": 1, "name": "Operational Bottleneck Analysis", "file_type": "md", "destination_folder": "03_Working_Papers", "is_review_gate": False, "is_client_deliverable": False, "wave": None},
    ...
    {"phase": 5, "output_number": 1, "name": "Executive Summary", "file_type": "md", "destination_folder": "04_Deliverables", "is_review_gate": False, "is_client_deliverable": False, "wave": None},
    {"phase": 5, "output_number": 2, "name": "Full Diagnostic Report", "file_type": "md", "destination_folder": "04_Deliverables", "is_review_gate": False, "is_client_deliverable": False, "wave": None},
    {"phase": 5, "output_number": 3, "name": "Presentation Deck", "file_type": "md", "destination_folder": "04_Deliverables", "is_review_gate": False, "is_client_deliverable": False, "wave": None},
    {"phase": 5, "output_number": 4, "name": "Implementation Roadmap", "file_type": "md", "destination_folder": "04_Deliverables", "is_review_gate": False, "is_client_deliverable": False, "wave": None},
    {"phase": 5, "output_number": 5, "name": "Phase 2 Retainer Proposal", "file_type": "md", "destination_folder": "04_Deliverables", "is_review_gate": False, "is_client_deliverable": False, "wave": None},
    # Phase 6 — Quality Control [REVIEW GATE]
    {"phase": 6, "output_number": 1, "name": "Citation Audit Report", "file_type": "md", "destination_folder": "05_QC", "is_review_gate": True, "is_client_deliverable": False, "wave": None},
    # Phase 7 — Document Packaging (Python renderer → docx/pptx from QC-approved markdown)
    {"phase": 7, "output_number": 1, "name": "Executive Summary", "file_type": "docx", "destination_folder": "04_Deliverables", "is_review_gate": False, "is_client_deliverable": True, "wave": 1},
    {"phase": 7, "output_number": 2, "name": "Full Diagnostic Report", "file_type": "docx", "destination_folder": "04_Deliverables", "is_review_gate": False, "is_client_deliverable": True, "wave": 1},
    {"phase": 7, "output_number": 3, "name": "Presentation Deck", "file_type": "pptx", "destination_folder": "04_Deliverables", "is_review_gate": False, "is_client_deliverable": True, "wave": 2},
    {"phase": 7, "output_number": 4, "name": "Implementation Roadmap", "file_type": "docx", "destination_folder": "04_Deliverables", "is_review_gate": False, "is_client_deliverable": True, "wave": 1},
    {"phase": 7, "output_number": 5, "name": "Phase 2 Retainer Proposal", "file_type": "docx", "destination_folder": "04_Deliverables", "is_review_gate": False, "is_client_deliverable": True, "wave": 2},
    # Phase 8 — Archive & Close Engagement [REVIEW GATE]
    {"phase": 8, "output_number": 1, "name": "Engagement Completion Manifest", "file_type": "md", "destination_folder": "05_QC", "is_review_gate": True, "is_client_deliverable": False, "wave": None},
    {"phase": 8, "output_number": 2, "name": "Lessons Learned Memo", "file_type": "md", "destination_folder": "03_Working_Papers", "is_review_gate": True, "is_client_deliverable": False, "wave": None},
]
